...
namespace CaveDevice
{
    class Program
    {
        ...
        private readonly static string connectionString = "HostName=iot-az220-training-lwk210831.azure-devices.net;DeviceId=sensor-th-0001;SharedAccessKey=62i57MPFK81rL1gHNJRk4Y7pHBq6yamG+6cXkzMCglI=";
        ...
        private static void Main(string[] args)
        {
            ...
            // Connect to the IoT hub using MQTT protocol
        ...
        private static async void SendDeviceToCloudMessagesAsync()
        {
            ...
            while(true)
            {
                ...
                // read ata from the sensor
                var currentTemperature = sensor.ReadTemperature();
                var currentHumidity = sensor.ReadHumidity();

                var messageString = CreateMessageString(currentTemperature, currentHumidity);

                // create byte array from the message string using ASCII enconding
                var message = new Message(Encoding.ASCII.GetBytes(messageString));

                // Add a custom application property to the message
                // An IoT hub can filter these properties without access to the message body.
